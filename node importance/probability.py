...
with open('D:/node importance/topic.txt', 'r') as f:
    data = f.readlines()
...
# need_words1 = open('D:/node importance/topic1.txt', encoding='utf_8')  # 这个是要查找的词的txt文件 每个词一行
# need_words2 = open('D:/node importance/topic2.txt', encoding='utf_8')
# need_words3 = open('D:/node importance/topic3.txt', encoding='utf_8')
find1 = []
find2 = []
find3 = []
...
with open('D:/node importance/node probability.csv', 'w', newline='') as csvfile:
